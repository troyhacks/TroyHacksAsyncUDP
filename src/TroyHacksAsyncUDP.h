...
#ifndef TROYHACKS_UDP_TASK_QUEUE_SIZE
  #define TROYHACKS_UDP_TASK_QUEUE_SIZE 32

#ifndef TROYHACKS_UDP_TASK_PRIORITY
  #define TROYHACKS_UDP_TASK_PRIORITY CONFIG_ARDUINO_UDP_TASK_PRIORITY

#ifndef TROYHACKS_UDP_TASK_RUNNING_CORE
  #define TROYHACKS_UDP_TASK_RUNNING_CORE CONFIG_ARDUINO_UDP_RUNNING_CORE
